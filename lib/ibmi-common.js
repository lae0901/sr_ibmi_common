...
exports.as400_tablesAndViews_select = exports.as400_srcmbrList = exports.as400_srcmbrLines = exports.as400_routines = exports.as400_srcfList = exports.as400_compile = void 0;
const sr_core_ts_1 = require("sr_core_ts");
const axios_1 = require("axios");
;
// --------------------- as400_compile -----------------------
async function as400_compile(config, srcfName, srcfLib, srcmbr) {
    const promise = new Promise(async (resolve, reject) => {
        srcfName = srcfName || '';
        srcfLib = srcfLib || '';
        srcmbr = srcmbr || '';
        const libl = sr_core_ts_1.string_rtrim(config.LIBL);
