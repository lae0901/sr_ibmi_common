...
exports.sqlTimestamp_toJavascriptDate = exports.as400_tablesAndViews_select = exports.as400_srcmbrList = exports.as400_srcmbrLines = exports.as400_routines = exports.as400_srcfList = exports.as400_rmvm = exports.as400_dspffd = exports.as400_compile = exports.as400_chgpfm = exports.as400_addpfm = exports.ibmi_ifs_getFileContents = exports.ibmi_ifs_getItems = void 0;
...
// --------------------- as400_chgpfm -----------------------
async function as400_chgpfm(fileName, libName, mbrName, textDesc, srcType, options) {
    const promise = new Promise(async (resolve, reject) => {
        fileName = fileName || '';
        libName = libName || '';
        mbrName = mbrName || '';
...
exports.as400_chgpfm = as400_chgpfm;
// --------------------- as400_compile -----------------------
...
async function as400_dspffd(libName, fileName, options) {
    const promise = new Promise(async (resolve, reject) => {
        options = options || {};
...
exports.as400_dspffd = as400_dspffd;
// --------------------- as400_rmvm -----------------------
...
async function as400_srcmbrList(libName, fileName, mbrName = '', options) {
    const promise = new Promise(async (resolve, reject) => {
        ...
        rows = rows.map((item) => {
            ...
            const dt = sr_core_ts_1.date_fromISO(CHGDATE, CHGTIME);
            const mtime = sr_core_ts_1.date_toEpoch(dt);
            return { ...item, mtime };
        });
        resolve(rows);
    });
...
function sqlTimestamp_toJavascriptDate(sql_ts) {
    let iso_ts = sr_core_ts_1.string_assignSubstr(sql_ts, 10, 1, 'T');
    iso_ts = iso_ts.replace(/\./g, ':');
    iso_ts = sr_core_ts_1.string_assignSubstr(iso_ts, 19, -1, '.000Z');
    const dt = new Date(iso_ts);
    return dt;
}
exports.sqlTimestamp_toJavascriptDate = sqlTimestamp_toJavascriptDate;
